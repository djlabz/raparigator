...
export function LoginScreen() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 md:grid md:grid-cols-2 md:items-start">
      ...
      <section className="px-4 py-10 sm:px-6 md:flex md:min-h-screen md:items-center md:justify-center md:px-12">
        <div className="mx-auto w-full max-w-md space-y-8">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <Button
              fullWidth
              size="lg"
              className="mt-2 shadow-md shadow-wine-700/20"
            >
          ...
          {/* Footer links */}
          <div className="border-t border-zinc-100 pt-6 text-center text-sm text-zinc-600 space-y-3">
            <p>
              Ainda não tem conta?{" "}
      ...
      <section className="hidden h-screen bg-black md:sticky md:top-0 md:block">
        <div className="relative h-full w-full overflow-hidden">
          <Image
            ...
            sizes="50vw"
          />
          {/* Gradiente da direita para a esquerda — cria sensação de "entrada" */}
          ...
          <div className="relative z-10 flex h-full flex-col justify-end px-10 pb-14 text-white lg:px-14">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-white/70">
              Privacidade, segurança e exclusividade em cada interação dentro do ecossistema Sigillus.
            </p>
          </div>
        </div>
      </section>
