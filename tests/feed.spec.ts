...
async function headerTitleOpacity(page: import('@playwright/test').Page, variant: 'premium' | 'standard') {
...
test.describe('Feed', () => {
  ...
  test('desktop: Outras modelos só aparece quando nenhum card premium está na visão', async ({ page }) => {
